...
Route::get('/', [BoldWareController::class, 'home'])->name('frontend.home');
...
Route::get('/product_detail/{id}', [BoldWareController::class,'Product_detail'])->name('frontend.Productdetail');
